...
urlpatterns = [
    ...
    path("api/bookings/<uuid:appointment_id>/reschedule-slots/", api_views.reschedule_slots, name="api_reschedule_slots"),
    path("api/bookings/<uuid:appointment_id>/reschedule/", api_views.booking_reschedule, name="api_booking_reschedule"),
    ...
    path("api/favorites/", api_views.favorites_list, name="api_favorites"),
    path("api/favorites/toggle/", api_views.favorite_toggle, name="api_favorite_toggle"),
